...
describe("checkResetContainers", () => {
    ...
    it("starts a prepend transaction instead of running the old reset path", () => {
        const previousData = [
            { id: "item-1", value: "A" },
            { id: "item-2", value: "B" },
            { id: "item-3", value: "C" },
    ...
    it("starts a prepend transaction even when the inserted batch exceeds startBuffered", () => {
        const previousData = [
            { id: "item-1", value: "A" },
            { id: "item-2", value: "B" },
            { id: "item-3", value: "C" },
