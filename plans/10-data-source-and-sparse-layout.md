...
- [ ] Add characterization tests and benchmark instrumentation for the current array-change, identity-reconciliation, sparse-layout, MVCP, grid, and million-item paths.
