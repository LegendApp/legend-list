...
- [x] Add `react-native` and `web` entrypoints, update exports/build config, and verify `tsc` output.
- [x] Update documentation to reflect the new import paths and typing guidance.
