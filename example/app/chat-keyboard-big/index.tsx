...
const defaultChatMessages: Message[] = [
    {
        id: String(idCounter++),
        sender: "user",
        text: "Hi, I have a question about your product" + "Hi, I have a question about your product",
    ...
    },
    {
        id: String(idCounter++),
        sender: "user",
        text: "I'm looking for information about pricing plans" + "I'm looking for information about pricing plans",
        timeStamp: Date.now() - MS_PER_SECOND * 4,
    },
    {
        id: String(idCounter++),
        sender: "bot",
        text:
            "We offer several pricing tiers based on your needs" +
            "We offer several pricing tiers based on your needs" +
            "We offer several pricing tiers based on your needs" +
            "We offer several pricing tiers based on your needs" +
            "We offer several pricing tiers based on your needs" +
    ...
    },
    {
        ...
        sender: "bot",
        text:
            "Our basic plan starts at $9.99 per month" +
            "Our basic plan starts at $9.99 per month" +
            "Our basic plan starts at $9.99 per month" +
            "Our basic plan starts at $9.99 per month" +
            "Our basic plan starts at $9.99 per month" +
    ...
    },
    {
        id: String(idCounter++),
        sender: "user",
        text: "Do you offer any discounts for annual billing?" + "Do you offer any discounts for annual billing?",
        timeStamp: Date.now() - MS_PER_SECOND * 4,
    },
    {
        id: String(idCounter++),
        sender: "bot",
        text:
            "Yes! You can save 20% with our annual billing option" +
            "Yes! You can save 20% with our annual billing option" +
            "Yes! You can save 20% with our annual billing option" +
            "Yes! You can save 20% with our annual billing option" +
            "Yes! You can save 20% with our annual billing option" +
    ...
    },
    {
        id: String(idCounter++),
        sender: "user",
        text: "That sounds great. What features are included?" + "That sounds great. What features are included?",
        timeStamp: Date.now() - MS_PER_SECOND * 4,
    },
    {
        id: String(idCounter++),
        sender: "bot",
        text:
            "The basic plan includes all core features plus 10GB storage" +
            "The basic plan includes all core features plus 10GB storage" +
            "The basic plan includes all core features plus 10GB storage" +
            "The basic plan includes all core features plus 10GB storage" +
            "The basic plan includes all core features plus 10GB storage" +
    ...
    },
    {
        ...
        sender: "bot",
        text:
            "Premium plans include priority support and additional tools" +
            "Premium plans include priority support and additional tools" +
            "Premium plans include priority support and additional tools" +
            "Premium plans include priority support and additional tools" +
            "Premium plans include priority support and additional tools" +
    ...
    },
    {
        id: String(idCounter++),
        sender: "user",
        text: "I think the basic plan would work for my needs" + "I think the basic plan would work for my needs",
        timeStamp: Date.now() - MS_PER_SECOND * 4,
    },
    {
        id: String(idCounter++),
        sender: "bot",
        text:
            "Perfect! I can help you get set up with that" +
            "Perfect! I can help you get set up with that" +
            "Perfect! I can help you get set up with that" +
            "Perfect! I can help you get set up with that" +
            "Perfect! I can help you get set up with that" +
    ...
    },
    {
        id: String(idCounter++),
        sender: "user",
        text: "Thanks for your help so far" + "Thanks for your help so far",
        timeStamp: Date.now() - MS_PER_SECOND * 4,
    },
    {
        id: String(idCounter++),
