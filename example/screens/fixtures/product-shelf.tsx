...
const SECTIONS = [
    { count: 9, title: "New Arrivals" },
    { count: 12, title: "On Sale" },
    { count: 6, title: "Trending" },
    { count: 9, title: "Top Rated" },
];
...
export default function ProductShelfFixtureScreen() {
